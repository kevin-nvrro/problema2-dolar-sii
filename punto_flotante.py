...
if __name__ == '__main__':
    ...
    print(f"Empezamos con: {monto} CLP")
    ...
    for p in precios:
        ...
        # para el grafico
        diferencia_mes = monto_actual - monto
        historial.append(diferencia_mes)
        
    diferencia_final = monto_actual - monto
    ...
    plt.plot(historial, marker='o', color='red')
    plt.title("Deriva de la ida y vuelta (Ejercicio B2)")
